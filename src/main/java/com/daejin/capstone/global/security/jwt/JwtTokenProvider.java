package com.daejin.capstone.global.security.jwt;

import com.daejin.capstone.domain.user.entity.UserRole;
import com.daejin.capstone.global.exception.ErrorCode;
import com.daejin.capstone.global.security.exception.InvalidAccessJwtException;
import com.daejin.capstone.global.security.exception.InvalidRefrashJwtException;
import com.daejin.capstone.global.security.exception.TokenExtractionException;
...
public class JwtTokenProvider {
  ...
  private String createToken(String userUuid, Long expirationMillis, JwtTokenType type, UserRole role) {
  ...
  public String createRefreshToken(String userUuid, UserRole role) {
    return this.createToken(
        userUuid
